...
const Admin = require("../models/waiterModel");
const Manager = require("../models/kitchenStaffModel");
const { expiryDate } = require("../helpers/expiryDate");

const employeeVerify_Jwt = (req, res, next) => {
  try {
...
module.exports = { employeeVerify_Jwt };
